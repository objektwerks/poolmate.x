...
final case class TimerSettingPage(poolId: Long, timerId: Long, id: Long = 0) extends EntityPage
final case class HeaterPage(poolId: Long, id: Long = 0) extends EntityPage
final case class HeaterSettingPage(poolId: Long, heaterId: Long, id: Long = 0) extends EntityPage
