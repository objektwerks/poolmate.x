...
object PageRouter:
  ...
  val timerSettingsRoute = Route.static(TimerSettingsPage, root / "app" / "pools" / "pool" / "timers" / "timer" / "timersettings" / endOfSegments)
  ...
  val heatersRoute = Route.static(HeatersPage, root / "app" / "pools" / "pool" / "heaters" / endOfSegments)
  ...
  val cleaningsRoute = Route.static(CleaningsPage, root / "app" / "pools" / "pool" / "cleanings" / endOfSegments)
  ...
  val suppliesRoute = Route.static(SuppliesPage, root / "app" / "pools" / "pool" / "supplies" / endOfSegments)
